...
Báo cáo này cung cấp khảo sát từ các kiến trúc nền tảng như Tacotron, FastSpeech đến các hệ thống sinh tiên tiến như VITS, VALL-E và StyleTTS 2, đồng thời phân tích bối cảnh dữ liệu cho tiếng Việt và các giải pháp an toàn AI như Watermarking.
...
*   **Hạn chế**:
    *   **Phase/Spectral mismatch**: Sự không khớp về pha hoặc đường bao phổ tại các điểm nối gây ra tiếng lách cách (clicks).
    *   **Thiếu linh hoạt**: Việc thay đổi cảm xúc yêu cầu phải thu âm lại toàn bộ cơ sở dữ liệu.
...
*   **Hạn chế**:
    *   **Robustness (Độ ổn định)**: Cơ chế Soft Attention đôi khi gây lỗi căn chỉnh (alignment failures), dẫn đến lặp từ hoặc bỏ sót từ.
    *   **Inference Speed (Tốc độ suy luận)**: Chậm do bản chất sinh tuần tự từng khung hình.

### 3.2. Các Mô hình Non-Autoregressive (Không tự hồi quy): FastSpeech 2
FastSpeech 2 cho phép sinh toàn bộ chuỗi Mel-spectrogram song song (parallel generation).
*   **Cải tiến cốt lõi: Variance Adaptor**
    *   **Duration Predictor**: Dự đoán thời lượng của từng âm vị để thực hiện Hard Alignment, loại bỏ hoàn toàn lỗi lặp từ.
    *   **Pitch & Energy Predictors**: Dự đoán cao độ và năng lượng giúp tăng khả năng biểu cảm.
...
1.  **Recent Advances in Speech Language Models: A Survey** - ACL Anthology
    *   [https://aclanthology.org/2025.acl-long.682.pdf](https://aclanthology.org/2025.acl-long.682.pdf)
2.  **[2410.03751] Recent Advances in Speech Language Models: A Survey** - arXiv
    *   [https://arxiv.org/abs/2410.03751](https://arxiv.org/abs/2410.03751)
3.  **A Survey on Neural Speech Synthesis** - arXiv
    *   [https://arxiv.org/pdf/2106.15561](https://arxiv.org/pdf/2106.15561)
4.  **Tacotron 1 and 2 Documentation** - Coqui TTS
    *   [https://docs.coqui.ai/en/latest/models/tacotron1-2.html](https://docs.coqui.ai/en/latest/models/tacotron1-2.html)
5.  **FastSpeech 2: Fast and Robust AI for Natural Text-to-Speech** - Zignuts Technolab
    *   [https://www.zignuts.com/ai/fastspeech-2](https://www.zignuts.com/ai/fastspeech-2)
6.  **FastSpeech: New text-to-speech model improves on speed, accuracy, and controllability** - Microsoft Research
    *   [Link](https://www.microsoft.com/en-us/research/blog/fastspeech-new-text-to-speech-model-improves-on-speed-accuracy-and-controllability/)
7.  **Fast Inference End-to-End Speech Synthesis with Style Diffusion** - MDPI
    *   [https://www.mdpi.com/2079-9292/14/14/2829](https://www.mdpi.com/2079-9292/14/14/2829)
8.  **HiFi-GAN Explained: Mastering High-Fidelity Audio in AI Solutions** - Vapi AI Blog
    *   [https://vapi.ai/blog/hifi-gan](https://vapi.ai/blog/hifi-gan)
9.  **HiFi-GAN: Generative Adversarial Networks for Efficient and High Fidelity Speech Synthesis** - GitHub
    *   [https://github.com/jik876/hifi-gan](https://github.com/jik876/hifi-gan)
10. **A Voice Cloning Method Based on the Improved HiFi-GAN Model** - PMC NIH
    *   [https://pmc.ncbi.nlm.nih.gov/articles/PMC9578849/](https://pmc.ncbi.nlm.nih.gov/articles/PMC9578849/)
11. **VITS Documentation** - Coqui TTS
    *   [https://docs.coqui.ai/en/dev/models/vits.html](https://docs.coqui.ai/en/dev/models/vits.html)
12. **VALL-E Project Page** - Microsoft Research
...
13. **Vietnamese TTS Model** - Hugging Face (ZaloPay)
    *   [https://huggingface.co/zalopay/vietnamese-tts](https://huggingface.co/zalopay/vietnamese-tts)
14. **Non-Standard Vietnamese Word Detection and Normalization for Text–to–Speech** - arXiv
    *   [https://arxiv.org/pdf/2209.02971](https://arxiv.org/pdf/2209.02971)
15. **VLSP 2021: Vietnamese Text-To-Speech Evaluation**
    *   [https://vlsp.org.vn/vlsp2021/eval/tts](https://vlsp.org.vn/vlsp2021/eval/tts)
16. **VinBigdata shares 100-hour data for the community** - VinBigdata Institute
    *   [Link](https://institute.vinbigdata.org/en/events/vinbigdata-shares-100-hour-data-for-the-community/)
17. **Zero-Shot Text-to-Speech for Vietnamese** - arXiv
    *   [https://arxiv.org/html/2506.01322v1](https://arxiv.org/html/2506.01322v1)
18. **Comparison of Voice Cloning Algorithms in Zero-shot and Few-shot Scenarios** – ResearchGate
    *   [Link](https://www.researchgate.net/publication/385500848_Comparison_of_Voice_Cloning_Algorithms_in_Zero-shot_and_Few-shot_Scenarios)
19. **Text-to-Speech Models: Multilingual Capabilities and Voice Cloning** - Eidos.ai
    *   [https://www.eidos.ai/blog-posts/text-to-speech-models-multilingual-capabilities-and-voice-cloning](https://www.eidos.ai/blog-posts/text-to-speech-models-multilingual-capabilities-and-voice-cloning)
20. **Proactive Detection of Voice Cloning with Localized Watermarking (AudioSeal)** - AI at Meta
    *   [https://ai.meta.com/research/publications/proactive-detection-of-voice-cloning-with-localized-watermarking/](https://ai.meta.com/research/publications/proactive-detection-of-voice-cloning-with-localized-watermarking/)
